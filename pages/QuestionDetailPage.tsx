            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                <Card className="mb-6">
                    <div className="p-6">
                        ...
                        <p className="leading-relaxed mb-4">{question.content}</p>
                        ...
                        <Card key={answer.id} className={answer.isVerified ? 'border-2 border-green-500' : ''}>
                             <div className="p-4 flex gap-4">
                                <div className="text-center flex-shrink-0">
                                    <button className="p-1 rounded-full hover:bg-border"><ArrowUp size={20} /></button>
                                    <p className="text-xl font-bold">{answer.votes}</p>
